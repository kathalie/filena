...
import '../../features/files_management/data/datasource_interfaces/storage_manager.dart';
...
final rootFolderIdProvider = Provider<int>((ref) {
  throw UnimplementedError('Root folder ID not initialized');
});
