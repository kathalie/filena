...
final fileVersionRepositoryProvider =
    AutoDisposeProvider<FileVersionRepository>.internal(
  fileVersionRepository,
  name: r'fileVersionRepositoryProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$fileVersionRepositoryHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
