...
const TagSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'fileVersions': LinkSchema(
      id: -1285691866353936301,
      name: r'fileVersions',
...
List<IsarLinkBase<dynamic>> _tagGetLinks(Tag object) {
  return [object.fileVersions];
}

void _tagAttach(IsarCollection<dynamic> col, Id id, Tag object) {
  object.id = id;
  object.fileVersions
      .attach(col, col.isar.collection<FileVersion>(), r'fileVersions', id);
}
...
extension TagQueryLinks on QueryBuilder<Tag, Tag, QFilterCondition> {
  QueryBuilder<Tag, Tag, QAfterFilterCondition> fileVersions(
      FilterQuery<FileVersion> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'fileVersions');
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> fileVersionsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'fileVersions', length, true, length, true);
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> fileVersionsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'fileVersions', 0, true, 0, true);
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> fileVersionsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'fileVersions', 0, false, 999999, true);
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> fileVersionsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'fileVersions', 0, true, length, include);
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> fileVersionsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'fileVersions', length, include, 999999, true);
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> fileVersionsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'fileVersions', lower, includeLower, upper, includeUpper);
    });
  }
}
