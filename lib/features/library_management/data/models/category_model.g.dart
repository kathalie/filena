...
void _categorySerialize(
  ...
  writer.writeStringList(offsets[0], object.extensions);
...
Category _categoryDeserialize(
  ...
  object.extensions = reader.readStringList(offsets[0]) ?? [];
  object.id = id;
...
extension CategoryQueryFilter
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> extensionsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'extensions',
        0,
...
extension CategoryQueryLinks
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition>
      rootCollectionIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'rootCollection', 0, true, 0, true);
    });
  }
}
...
extension CategoryQueryWhereDistinct
  ...
  QueryBuilder<Category, Category, QDistinct> distinctByExtensions() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQueryProperty
  ...
  QueryBuilder<Category, List<String>, QQueryOperations> extensionsProperty() {
    return QueryBuilder.apply(this, (query) {
